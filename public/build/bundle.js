...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    class CalculadoraModel {
        ...
        calcular(proximaOperacao = null) {
            const acumulador = !__classPrivateFieldGet(this, _CalculadoraModel_operacao, "f")
                ...
                : eval(`${__classPrivateFieldGet(this, _CalculadoraModel_acumulador, "f")} ${__classPrivateFieldGet(this, _CalculadoraModel_operacao, "f")} ${__classPrivateFieldGet(this, _CalculadoraModel_valor, "f")}`); // Código do JavaScript para utilizar para casos que envolve mais uma váriavel ou const para aplicar um cálculo.
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*texto*/ ctx[0]);
    			attr_dev(button, "class", "botao svelte-1sz8s22");
    			...
    			add_location(button, file$4, 12, 0, 267);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (texto === undefined && !('texto' in $$props || $$self.$$.bound[$$self.$$.props['texto']])) {
    			console_1.warn("<Botao> was created without expected prop 'texto'");
    		}
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t = text(/*valor*/ ctx[0]);
    			add_location(span, file$2, 5, 4, 159);
    			attr_dev(div, "class", div_class_value = "" + (null_to_empty(`tela ${/*tamanhoFonte*/ ctx[1]}`) + " svelte-1uli5ip"));
    			add_location(div, file$2, 4, 0, 118);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*tamanhoFonte*/ 2 && div_class_value !== (div_class_value = "" + (null_to_empty(`tela ${/*tamanhoFonte*/ ctx[1]}`) + " svelte-1uli5ip"))) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "calculadora svelte-1el3b44");
    			add_location(div, file$1, 12, 0, 507);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [calc, numeroDigitado, operacaoDigitada, calcular, pontoDigitado, limpar];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1j3wtpy");
