...
export default class CalculadoraModel {
    ...
    calcular(proximaOperacao: string = null) {
        const acumulador = !this.#operacao
            ...
            : eval(`${this.#acumulador} ${this.#operacao} ${this.#valor}`) // Código do JavaScript para utilizar para casos que envolve mais uma váriavel ou const para aplicar um cálculo.
